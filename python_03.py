...
#Sincronizar para obtener cambios más recientes: git pull
#Agregar un archivo al área de stage: git add <ARCHIVO>
#Crear un commit con los archivos del área de stage: git commit -m “Mensaje commit”
#Crear un nuevo branch en nuestra computadora: git checkout -b <BRANCH>
#Cambiar a un branch existente: git checkout <BRANCH>